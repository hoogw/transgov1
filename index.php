              ...
              <a href="http://glassgov.transparentgov.net" target="_blank">
                <div class="card card-avatar z-depth-5 waves-effect waves-block waves-light">
                    ...
                    <div class="waves-effect waves-block waves-light">
                        <img class="activator" src="img/cloud4.png">
                    </div>
...
<footer id="contact" class="page-footer default_color scrollspy">
    ...
    <div class="footer-copyright default_color">
        <div class="container">
           ...
           <small>
           <i class="fa fa-copyright"></i> <?php echo date("Y"); ?>  Made by <a class="white-text" href="#">Joe hu</a> 310-710-6501 <a class="white-text" href="#">huguowen@gmail.com</a>
           </small>  
        </div>
    </div>
</footer>
